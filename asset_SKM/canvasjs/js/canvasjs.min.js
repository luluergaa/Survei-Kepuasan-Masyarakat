...
(function () {
	...
	V.prototype.setOptions = function (h, m) { if (pa[this._defaultsKey]) { var s = pa[this._defaultsKey], v; for (v in s) "publicProperties" !== v && s.hasOwnProperty(v) && (this[v] = h && v in h ? h[v] : m && v in m ? m[v] : s[v]) } else Ga && window.console && console.log("defaults not set") }; V.prototype.get = function (h) {
		...
		function () { return { x1: this._x1 + this._leftOccupied, y1: this._y1 + this._topOccupied, x2: this._x2 - this._rightOccupied, y2: this._y2 - this._bottomOccupied, width: this._x2 - this._x1 - this._rightOccupied - this._leftOccupied, height: this._y2 - this._y1 - this._bottomOccupied - this._topOccupied } }; Ca.prototype.reset = function () { this._rightOccupied = this._leftOccupied = this._bottomOccupied = this._topOccupied = this._padding }; na(ia, V); ia.prototype._initialize = function () {
										...
										this.parent.labelFontSize : this.labelFontSize; this.labelMaxWidth = s(this.options.labelMaxWidth) ? 0.3 * this.chart.width : this.labelMaxWidth; this.labelMaxHeight = s(this.options.labelWrap) || this.labelWrap ? 0.3 * this.chart.height : 2 * this.labelFontSize; 0 < p && q.setLineDash && q.setLineDash(N(this.lineDashType, p)); k = new ia(q, {
															...
															Math.abs(a - this.parent.convertValueToPixel(n[r].dataPoint.y[x])), t < v && (v = t, w = r); else z += n[r].dataPoint.y, y = n[r].dataPoint.x.getTime ? n[r].dataPoint.x.getTime() : n[r].dataPoint.x, y = 100 * (z / n[r].dataSeries.plotUnit.dataPointYSums[y]), t = Math.abs(a - this.parent.convertValueToPixel(y)), t < v && (v = t, w = r); else for (v = Math.abs(a - this.parent.convertValueToPixel(n[0].dataPoint.y)), r = w = t = 0; r < n.length; r++)if (n[r].dataPoint.y && n[r].dataPoint.y.length) for (x = 0; x < n[r].dataPoint.y.length; x++)t = Math.abs(a - this.parent.convertValueToPixel(n[r].dataPoint.y[x])),
																t < v && (v = t, w = r); else t = Math.abs(a - this.parent.convertValueToPixel(n[r].dataPoint.y)), t < v && (v = t, w = r); x = n[w]; if ("bottom" === this.parent._position || "top" === this.parent._position) {
																	b = 0; if ("rangeBar" === this.parent.dataSeries[w].type || "error" === this.parent.dataSeries[w].type) {
																		...
																		v = Math.abs(a - this.parent.convertValueToPixel(n[0].dataPoint.y)); z = t = 0; for (r = w; 0 <= r; r--)z += n[r].dataPoint.y, t = Math.abs(a -
																			this.parent.convertValueToPixel(z)), t < v && (v = t, b = r); h = 1 === q.lineWidth % 2 ? (this.parent.convertValueToPixel(z) << 0) + 0.5 : this.parent.convertValueToPixel(z) << 0; this.value = z; k.text = this.labelFormatter ? this.labelFormatter({ chart: this.chart, axis: this.parent.options, crosshair: this.options, value: c ? c : x.dataPoint.y }) : s(this.options.label) ? ea(c ? c : x.dataPoint.y, this.valueFormatString, this.chart._cultureInfo) : this.label
																		...
																		y = z = t = 0; for (r = w; 0 <= r; r--)z += n[r].dataPoint.y, y = n[r].dataPoint.x.getTime ? n[r].dataPoint.x.getTime() : n[r].dataPoint.x, y = 100 * (z / n[r].dataSeries.plotUnit.dataPointYSums[y]), t = Math.abs(a - this.parent.convertValueToPixel(y)), t < v && (v = t, b = r); h = 1 === q.lineWidth % 2 ? (this.parent.convertValueToPixel(y) << 0) + 0.5 : this.parent.convertValueToPixel(y) << 0; this.value = y; k.text = this.labelFormatter ? this.labelFormatter({ chart: this.chart, axis: this.parent.options, crosshair: this.options, value: c ? c : y }) : s(this.options.label) ? ea(c ?
																			c : y, this.valueFormatString, this.chart._cultureInfo) : this.label
																...
																t < v && (v = t, w = r); else z += n[r].dataPoint.y, y = n[r].dataPoint.x.getTime ? n[r].dataPoint.x.getTime() : n[r].dataPoint.x, y = 100 * (z / n[r].dataSeries.plotUnit.dataPointYSums[y]), t = Math.abs(d - this.parent.convertValueToPixel(y)), t < v && (v = t, w = r); else for (v = Math.abs(d - this.parent.convertValueToPixel(n[0].dataPoint.y)), r = t = 0; r < n.length; r++)if (n[r].dataPoint.y && n[r].dataPoint.y.length) for (x = 0; x < n[r].dataPoint.y.length; x++)t = Math.abs(d - this.parent.convertValueToPixel(n[r].dataPoint.y[x])), t < v && (v = t, w = r); else t = Math.abs(d -
																	this.parent.convertValueToPixel(n[r].dataPoint.y)), t < v && (v = t, w = r); x = n[w]; b = 0; if ("rangeColumn" === this.parent.dataSeries[w].type || "rangeArea" === this.parent.dataSeries[w].type || "error" === this.parent.dataSeries[w].type || "rangeSplineArea" === this.parent.dataSeries[w].type || "candlestick" === this.parent.dataSeries[w].type || "ohlc" === this.parent.dataSeries[w].type || "boxAndWhisker" === this.parent.dataSeries[w].type) {
																		...
																		this.parent.dataSeries[w].type || "stackedArea" === this.parent.dataSeries[w].type) {
																			v = Math.abs(d - this.parent.convertValueToPixel(n[0].dataPoint.y)); z = t = 0; for (r = w; 0 <= r; r--)z += n[r].dataPoint.y, t = Math.abs(d - this.parent.convertValueToPixel(z)), t < v && (v = t, b = r); m = 1 === q.lineWidth % 2 ? (this.parent.convertValueToPixel(z) << 0) + 0.5 : this.parent.convertValueToPixel(z) << 0; k.text = this.labelFormatter ? this.labelFormatter({ chart: this.chart, axis: this.parent.options, crosshair: this.options, value: c ? c : x.dataPoint.y }) : s(this.options.label) ?
																				ea(c ? c : x.dataPoint.y, this.valueFormatString, this.chart._cultureInfo) : this.label; this.value = z
												} else if ("stackedColumn100" === this.parent.dataSeries[w].type || "stackedArea100" === this.parent.dataSeries[w].type) {
													v = Math.abs(d - this.parent.convertValueToPixel(n[0].dataPoint.y)); z = t = 0; for (r = w; 0 <= r; r--)z += n[r].dataPoint.y, y = n[r].dataPoint.x.getTime ? n[r].dataPoint.x.getTime() : n[r].dataPoint.x, y = 100 * (z / n[r].dataSeries.plotUnit.dataPointYSums[y]), t = Math.abs(d - this.parent.convertValueToPixel(y)), t < v && (v = t, b = r); m =
											...
											if ("bottom" === this.parent._position || "top" === this.parent._position) b = e = h = 1 === q.lineWidth % 2 ? (a << 0) + 0.5 : a << 0, f = this.chart.plotArea.y1, l = this.chart.plotArea.y2, this.bounds = { x1: b - p / 2, y1: f, x2: e + p / 2, y2: l }; else if ("left" === this.parent._position || "right" === this.parent._position) f = l = m = 1 === q.lineWidth % 2 ? (d << 0) + 0.5 : d << 0, b = this.chart.plotArea.x1, e = this.chart.plotArea.x2,
												this.bounds = { x1: b, y1: f - p / 2, x2: e, y2: l + p / 2 }; if ("xySwapped" === this.chart.plotInfo.axisPlacement) if ("left" === this.parent._position || "right" === this.parent._position) {
													...
													y = !1; n = ""; if (this.parent.labels) for (n = Math.ceil(this.parent.interval),
			...
			}(); y.version = "v3.2.18 GA"; window.CanvasJS && (y && !window.CanvasJS.Chart) && (window.CanvasJS.Chart = y)
})();
